...
public class PointContainer extends FrameLayout {
    ...
    public PointContainer(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }

    public PointContainer(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void startPointSpread(final ImageView starView, final Runnable finishRunnable) {
        ...
        scaleYAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animation) {
                ...
                starView.setImageDrawable(PointContainer.this.getResources().getDrawable(R.mipmap.icon_rating_star));
            }
        });
        new ValueAnimator();
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                PointContainer.this.pointRadial = dp2px(PointContainer.this.getContext(), (float) value);
                PointContainer.this.invalidate();
            }
        });
        valueAnimator.addListener(new AnimatorListenerAdapter() {
            public void onAnimationStart(Animator animation) {
                super.onAnimationStart(animation);
                PointContainer.this.isDrawPoint = true;
            }
        });
        ...
        valueAnimatorAlphaIn.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            public void onAnimationUpdate(ValueAnimator animation) {
                int value = ((Integer) animation.getAnimatedValue()).intValue();
                PointContainer.this.pointAlpha = value;
                PointContainer.this.invalidate();
            }
        });
        ...
        valueAnimatorAlphaOut.addListener(new AnimatorListenerAdapter() {
            public void onAnimationEnd(Animator animation) {
                ...
                PointContainer.this.isDrawPoint = false;
